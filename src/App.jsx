    ...
    <>
      ...
      <section id="projects" className="py-20 bg-gray-100">
        <div className="container mx-auto px-4 sm:px-6 mb-12">
          <h2 className="text-4xl font-extrabold text-center bg-gradient-to-r from-blue-600 to-slate-800 text-transparent bg-clip-text">
            {projectsTitle}
          </h2>
        </div>
      ...
      <main className="container mx-auto px-6">
        ...
        >
          <div className="w-full max-w-5xl mx-auto">
            <h2 className="text-4xl font-extrabold text-center mb-12 bg-gradient-to-r from-blue-600 to-slate-800 text-transparent bg-clip-text">
              {timelineTitle}
            </h2>
